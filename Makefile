...
TestJeuDeLaVie:
	javac -d bin -classpath bin/gui.jar -sourcepath src src/TestJeuDeLaVie.java
	java -classpath bin:bin/gui.jar TestJeuDeLaVie
TestJeuImmigration:
	javac -d bin -classpath bin/gui.jar -sourcepath src src/TestJeuImmigration.java
	java -classpath bin:bin/gui.jar TestJeuImmigration
TestSchelling:
